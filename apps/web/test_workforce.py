...
class WorkforceTests(TestCase):
    ...
    def test_registration_inactive_and_csrf_enforced(self):
        ...
        self.assertEqual(dashboard.context['account_request_count'], 1)
        self.assertContains(dashboard, f'/employees/{new.pk}/')
        ...
        self.assertEqual(self.client.get('/').context['account_request_count'], 0)
